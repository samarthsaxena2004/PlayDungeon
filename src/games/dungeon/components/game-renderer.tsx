  ...
  useEffect(() => {
    ...
    for (let y = startTileY; y < endTileY; y++) {
      for (let x = startTileX; x < endTileX; x++) {
        ...
        // Draw tile
        ctx.fillStyle = (COLORS as any)[tile.type] || COLORS.floor;
    ...
    for (const milestone of milestones) {
      ...
      gradient.addColorStop(0, `${(COLORS.milestone as any)[milestone.type]}44`);
      ...
      // Draw milestone
      ctx.fillStyle = (COLORS.milestone as any)[milestone.type];
    ...
    for (const enemy of enemies) {
      ...
      // Draw enemy body
      ctx.fillStyle = (COLORS.enemy as any)[enemy.type];
