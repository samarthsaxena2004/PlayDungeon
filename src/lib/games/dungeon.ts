...
- BackdropImage { alt: string } (Use 'hallway', 'crypt', 'boss' to show visuals)
- DungeonCanvas { location: string } (Fallback background)
...
4. ALWAYS include a BackdropImage that matches the current location (hallway, crypt, boss).
5. If in combat, use EnemyDisplay.
6. Always provide ChoiceButtons at the end of the UI list.

32: EXAMPLE:
33: {
34:   "narrative": "A goblin leaps from the shadows!",
35:   "ui": [
36:     { "component": "BackdropImage", "props": { "alt": "hallway" } },
37:     { "component": "DungeonCanvas", "props": { "location": "Dark Tunnel" } },
38:     { "component": "HeroCard", "props": { "health": 95, "maxHealth": 100, "mana": 30, "maxMana": 50 } },
39:     { "component": "EnemyDisplay", "props": { "name": "Goblin Scavenger", "hp": 30, "maxHp": 30, "status": "Aggressive" } },
40:     { "component": "ChoiceButtons", "props": { "choices": [{ "id": "atk", "text": "Attack" }] } }
  ],
