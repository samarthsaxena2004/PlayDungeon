    ...
    <div className="fixed inset-0 bg-[#060610] flex flex-col items-center justify-center p-6 z-50">
      ...
      <AnimatePresence>
        {isReady && (
          ...
          >
            <div className="w-full bg-[hsl(220,15%,8%)]/80 border border-[hsl(var(--border))] rounded-lg p-4 backdrop-blur-sm">
              <label
                htmlFor="playerName"
                className="block text-[10px] font-pixel text-[hsl(var(--muted-foreground))] mb-2"
              >
                HERO NAME
              </label>
              <input
                ...
                className="w-full px-3 py-2 bg-[hsl(220,15%,6%)] border border-[hsl(var(--border))] rounded text-sm text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))] focus:outline-none focus:ring-1 focus:ring-[hsl(var(--primary))] transition-all"
                onKeyDown={(e) => {
            ...
            <button
              ...
              className="relative px-10 py-3 rounded-lg bg-gradient-to-r from-orange-600 to-red-600 text-[hsl(var(--primary-foreground))] font-pixel text-sm shadow-lg shadow-orange-900/40 hover:from-orange-500 hover:to-red-500 transition-all"
            >
              <motion.div
